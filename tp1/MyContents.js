...
class MyContents  {
    ...
    */
    ...
    buildFlower() {
        let petalMaterial = new THREE.MeshPhongMaterial({ color: "#ffff77",
        specular: "#ff0000", emissive: "#ff0000", shininess: 90 });

        let centerMaterial = new THREE.MeshPhongMaterial({ color: "#ffffff",
        specular: "#ff0000", emissive: "#ffffff", shininess: 90 });
    ...
    init() {
        ...
        this.candleMesh.position.set(0.1, 1.3, -0.1);
